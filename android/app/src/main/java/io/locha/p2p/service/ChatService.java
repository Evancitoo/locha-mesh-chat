...
import io.locha.p2p.service.IChatService;
...
public class ChatService extends Service {
    ...
    @Override public IBinder onBind(Intent intent) {
        return new IChatService.Stub() {
            @Override public void dial(String multiaddr) throws RemoteException {
                runtime.dial(multiaddr);
            }

            @Override public void sendMessage(String contents) throws RemoteException {
                runtime.sendMessage(contents);
            }

            @Override public String getPeerId() throws RemoteException {
    ...
    @Override public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        try {
            ...
            /* Initialize Runtime */
            this.runtime = new Runtime(dispatcher, privateKey, attemptUpnp);
    ...
    private void createNotificationChannel() {
        String NOTIFICATION_CHANNEL_NAME = "Background Service";
